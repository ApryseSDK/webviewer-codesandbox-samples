!(function(t) {
  ...
  function(t, n, r) {
    ...
    var o = r(1),
      ...
      Z = function(t) {
        ...
        return !(this === B && i(G, t) && !i(V, t)) && (!(n || !i(this, t) || !i(G, t) || (i(this, C) && this[C][t])) || n);
      },
      Q = function(t, n) {
        if (((t = w(t)), (n = _(n, !0)), t !== B || !i(G, n) || i(V, n))) {
          var r = I(t, n);
      ...
      nt = function(t) {
        for (var n, r = t === B, e = T(r ? V : w(t)), o = [], u = 0; e.length > u; ) !i(G, (n = e[u++])) || (r && !i(B, n)) || o.push(G[n]);
        return o;
      };
    z ||
      (f(
  ...
  function(t, n) {
    WebViewer(
      ...
      samplesSetup(t);
      var n = t.UI.getCurrentLanguage(),
        r = document.querySelector('form > #'.concat(n));
      r && (r.checked = !0),
