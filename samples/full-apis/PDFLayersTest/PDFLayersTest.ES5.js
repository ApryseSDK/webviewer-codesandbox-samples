!(function(t) {
  ...
  function(t, n, e) {
    ...
    t.exports = function(t, n, e, v, y, d, g) {
      ...
      if (
        (j && (b = s(j.call(new t()))) !== Object.prototype && b.next && (f(b, w, !0), r || 'function' == typeof b[l] || u(b, l, h)),
        _ &&
          P &&
          'values' !== P.name &&
          ((O = !0),
      ...
      return [
        ...
        function(t, n) {
          ...
          for (var b, S = '', w = 0, _ = 0; _ < m.length; _++) {
            ...
            E >= w && ((S += p.slice(w, E) + A), (w = E + O.length));
          }
          return S + p.slice(w);
        },
      ];
          ...
          c = (function() {
            var t = o(
              regeneratorRuntime.mark(function t() {
                var o, c, a, f, s, l, p, h, v, y, d, g, m, x, b, S, w, _, O, E, P, F, M, j, A;
                  ...
                  function(t) {
                    for (;;)
                      switch ((t.prev = t.next)) {
                        ...
                        case 193:
                          (A = t.sent), saveBufferAsPNG(A, 'pdf_layers_non_oc.png');
                        case 195:
