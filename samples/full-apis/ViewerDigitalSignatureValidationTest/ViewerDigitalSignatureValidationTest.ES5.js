!(function(t) {
  ...
  function(t, n) {
    ...
    (r = window.parent.document),
      ...
      (f = r.getElementById('certificate-url')),
      (a = r.getElementById('document-url')),
