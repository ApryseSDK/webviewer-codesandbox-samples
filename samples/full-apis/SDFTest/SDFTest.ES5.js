                    ...
                    function(t) {
                      for (;;)
                        switch ((t.prev = t.next)) {
                          ...
                          case 23:
                            return (a = t.sent).putString('Producer', 'PDFTron PDFNet'), (t.next = 27), a.find('Author');
                          case 27:
                          ...
                          case 36:
                            (s = t.sent), a.putText('Author', s + ' - Modified'), (t.next = 41);
                            break;
                          case 40:
                            a.putString('Author', 'Me, myself, and I');
                          case 41:
                            t.next = 48;
                            break;
                          case 43:
                          ...
                          case 45:
                            (a = t.sent).putString('Producer', 'PDFTron PDFNet'), a.putString('Title', 'My document');
                          case 48:
                            return (t.next = 50), a.putDict('My Direct Dict');
                          case 50:
                            return (l = t.sent).putNumber('My Number', 100), l.putArray('My Array'), (t.next = 55), i.createIndirectArray();
                          case 55:
                            return (h = t.sent), a.put('My Indirect Array', h), (t.next = 59), u.get('Root');
                          case 59:
