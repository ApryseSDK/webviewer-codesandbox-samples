!(function(t) {
  ...
  function(t, n, e) {
    ...
    t.exports = function(t, n, e, v, d, y, g) {
      ...
      if (
        ...
        if (((m = { values: _ ? T : S('values'), keys: y ? T : S('keys'), entries: F }), g)) for (b in m) b in O || i(O, b, m[b]);
    ...
    var o = e(1),
      ...
      K = function(t, n, e) {
        return (
          ...
          (n = _(n, !0)),
          b(e),
          i(V, n) ? (e.enumerable ? (i(t, L) && t[L][n] && (t[L][n] = !1), (e = O(e, { enumerable: E(0, !1) }))) : (i(t, L) || I(t, L, E(1, {})), (t[L][n] = !0)), Y(t, n, e)) : I(t, n, e)
        );
      },
      X = function(t, n) {
        b(t);
      ...
      return [
        ...
        function(t, n) {
          ...
          for (var x, S = '', w = 0, _ = 0; _ < m.length; _++) {
            b = m[_];
            for (var E = String(b[0]), O = f(s(u(b.index), p.length), 0), P = [], T = 1; T < b.length; T++) P.push(void 0 === (x = b[T]) ? x : String(x));
            var F = b.groups;
            if (h) {
              var A = [E].concat(P, O, p);
              void 0 !== F && A.push(F);
              var M = String(n.apply(void 0, A));
            } else M = d(E, p, O, P, F, n);
        ...
        return (
          ...
          (P.prototype = {
            ...
            delegateYield: function(t, n, e) {
              return (this.delegate = { iterator: T(t), resultName: n, nextLoc: e }), 'next' === this.method && (this.arg = void 0), p;
            },
          }),
          t
        );
  ...
  function(t, n) {
     ...
     * http://modernizr.com/download/?-applicationcache-audio-backgroundsize-borderimage-borderradius-boxshadow-canvas-canvastext-cssanimations-csscolumns-cssgradients-cssreflections-csstransforms-csstransforms3d-csstransitions-flexbox-fontface-generatedcontent-generators-geolocation-hashchange-history-hsla-indexeddb-inlinesvg-input-inputtypes-localstorage-multiplebgs-opacity-postmessage-rgba-sessionstorage-smil-svg-svgclippaths-textshadow-video-webgl-websockets-websqldatabase-webworkers-addtest-domprefixes-hasevent-prefixes-testallprops-testprop-teststyles ! */ !(function(
      ...
      function u(t, n) {
        if ('object' === e(t)) for (var r in t) O(t, r) && u(r, t[r]);
        else {
      ...
      m._domPrefixes = E;
      var O,
        P = m._config.usePrefixes ? ' -webkit- -moz- -o- -ms- '.split(' ') : [];
      (m._prefixes = P),
        (function() {
      ...
      (b.inputtypes = (function(t) {
        ...
        b.addTest('cssgradients', function() {
          var t = 'background-image:',
            n = t + P.join('linear-gradient(left top,#9f9, white);' + t).slice(0, -t.length);
