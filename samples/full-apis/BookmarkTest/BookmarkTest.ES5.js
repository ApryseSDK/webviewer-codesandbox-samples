          ...
          i = (function() {
            var t = e(
              regeneratorRuntime.mark(function t() {
                var r, e, i, u, c, a, f, s, l, p, h, v, y, d, g, x, m, b, S, w, _, E, F, O, P, A, M, k, j, I, N, T, R, L;
                return regeneratorRuntime.wrap(function(t) {
                  for (;;)
                    switch ((t.prev = t.next)) {
                      case 0:
                      ...
                      case 226:
                        return (T = t.sent).putName('S', 'GoToR'), T.putBool('NewWindow', !0), T.put('F', M), (t.next = 232), T.putArray('D');
                      case 232:
                        return (R = t.sent).pushBackNumber(9), R.pushBackName('Fit'), (t.next = 237), e.saveMemoryBuffer(n.SDFDoc.SaveOptions.e_remove_unused);
                      case 237:
