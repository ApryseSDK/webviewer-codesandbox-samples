!(function(t) {
  ...
  function(t, n, e) {
    ...
    t.exports = function(t, n) {
      ...
      return function(n, c, v) {
        for (var y, d, g = i(n), x = o(g), m = r(c, v, 3), b = u(x.length), S = 0, w = e ? p(n, b) : a ? p(n, 0) : void 0; b > S; S++)
  ...
  function(t, n, e) {
    ...
    ((n = t.exports = function(t, n, e, l, h) {
      ...
      if (i(g)) {
        for (p = c(t.length); p > m; m++) if ((d = n ? x(u((v = t[m]))[0], v[1]) : x(t[m])) === s || d === f) return d;
      ...
      e(2)(function() {
        ...
        ? function(t, n) {
            for (var e = c(t), s = arguments.length, f = 1, l = i.f, h = u.f; s > f; )
              for (var p, v = a(arguments[f++]), y = l ? o(v).concat(l(v)) : o(v), d = y.length, g = 0; d > g; ) (p = y[g++]), (r && !h.call(v, p)) || (e[p] = v[p]);
            return e;
          }
        : s;
  },
        ...
        toFixed: function(t) {
          ...
          if ((a < 0 && ((y = '-'), (a = -a)), a > 1e-21))
            if (
              ...
              h(1 << r), l(1, 1), h(2), (d = p());
            } else l(0, e), l(1 << -n, 0), (d = p() + u.call('0', s));
      ...
      'Array',
      {
        from: function(t) {
          var n,
            ...
            g = 0,
            x = f(h);
          if ((d && (y = r(y, v > 2 ? arguments[2] : void 0, 2)), null == x || (p == Array && c(x)))) for (e = new p((n = a(h.length))); n > g; g++) s(e, g, d ? y(h[g], g) : h[g]);
          else for (l = x.call(h), e = new p(); !(o = l.next()).done; g++) s(e, g, d ? u(l, y, [o.value, g], !0) : o.value);
          return (e.length = g), e;
        },
      }
    );
            ...
            var t,
              r =
                ((t = regeneratorRuntime.mark(function t() {
                  var e, r, o, i, u, c, a, s, f, l, h, p, v, y, d, g, x, m, b, S, w, _, E, P, F, O, T;
                      ...
                      for (;;)
                        switch ((t.prev = t.next)) {
                          ...
                          case 277:
                            ...
                            break;
                          case 280:
                            return p.end(), u.end(), o.pagePushBack(f), (t.t57 = p), (t.t58 = o), (t.next = 287), o.getPageCount();
                          case 287:
                          ...
                          case 315:
                            ...
                            break;
                          case 318:
                            return p.end(), u.end(), o.pagePushBack(f), (t.next = 323), o.pageCreate();
                          case 323:
