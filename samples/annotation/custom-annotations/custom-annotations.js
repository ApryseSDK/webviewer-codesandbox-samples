...
(function(exports) {
  ...
  WebViewer({
    ...
    .then((instance) => {
      ...
      const isTriangleAnnot = (annotation) => annotation &&
        annotation[exports.TriangleAnnotationFactory.ANNOT_TYPE]
        && annotation[exports.TriangleAnnotationFactory.ANNOT_TYPE] === exports.TriangleAnnotationFactory.TRIANGLE_ANNOT_ID;
      const addTriangleTool = () => {
        registerTool({
          ...
          tooltip: 'Triangle'
        }, TriangleAnnotation, (annotation) => isTriangleAnnot(annotation));
        ...
        fileReader.onload = () => {
          ...
          uploadImg.onload = () => {
            ...
            addStamp(
              result,
              {},
              { width: imgWidth, height: (uploadImg.height / uploadImg.width) * imgWidth }
            );
          };
