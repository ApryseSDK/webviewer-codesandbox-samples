  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n, r, v, y, g, d) {
      ...
      if (
        ...
        if (((b = { values: _ ? M : S('values'), keys: g ? M : S('keys'), entries: F }), d)) for (m in b) m in E || i(E, m, b[m]);
        ...
        [
          ...
          function(t, n) {
            ...
            for (var x = 0, S = 0, w = []; S < h.length; ) {
              ...
              var _,
                O = f(b, v ? h : h.slice(S));
              if (null === O || (_ = l(c(b.lastIndex + (v ? 0 : S)), h.length)) === x) S = u(h, S, g);
              else {
      ...
      var a = {
        ...
        combinePixels: function(a, s, l, h, p, v) {
          ...
          for (var O = 0; O < x.length; O += r) {
            var E = ((d = O), (b = a.width), (m = void 0), { x: (m = Math.floor(d / r)) % b, y: Math.floor(m / b) }),
              P = i(E, s.width),
              M = f(x, O),
              F = f(S, P),
              j = { r: M[n.R], g: M[n.G], b: M[n.B], a: M[n.A] };
            if (e(F[n.R], F[n.G], F[n.B], F[n.A]) && e(M[n.R], M[n.G], M[n.B], M[n.A])) j = o(o({}, j), {}, { a: 0 });
            else if (
              v &&
              ((y = { r: F[n.R], g: F[n.G], b: F[n.B], a: F[n.A] }), (g = { r: M[n.R], g: M[n.G], b: M[n.B], a: M[n.A] }), y && g && y.r === g.r && y.g === g.g && y.b === g.b && y.a === g.a)
            ) {
              var A = u([M[n.R], M[n.G], M[n.B]]) / 2;
              j = o(o({}, j), {}, { r: Math.ceil(127.5) + A, g: Math.ceil(127.5) + A, b: Math.ceil(127.5) + A });
            } else if (E.y <= s.height && E.x <= s.width)
              if (e(F[n.R], F[n.G], F[n.B], F[n.A])) {
                var I = Math.round(255 * h),
                  R = u([M[n.R], M[n.G], M[n.B]]);
                j = { r: v ? R : M[n.R], g: v ? R : M[n.G], b: v ? 255 : M[n.B], a: I };
              } else if (e(M[n.R], M[n.G], M[n.B], M[n.A])) {
