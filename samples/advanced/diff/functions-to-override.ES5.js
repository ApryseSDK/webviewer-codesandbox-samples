                    ...
                    for (;;)
                      switch ((n.prev = n.next)) {
                        case 0:
                          ...
                          for (u = Math.max(c.getPageCount(), f.getPageCount()), p = 1; p <= u; p++)
                            (v = c.getPageInfo(p)),
                              (g = f.getPageInfo(p)),
                              (y = void 0),
                              (d = void 0),
                              this.alignmentPageStates.setTransformationStateForPageNumber(p, t.DEFAULT_TRANSFORM_STATE),
                              this.nudgePageStates.setTransformationStateForPageNumber(p, t.DEFAULT_NUDGE_STATE),
                              v && g
                                ? ((m = Math.max(v.width, g.width)), (b = Math.max(v.height, g.height)), (d = c.getPages()[p - 1]), ((y = l(p, d)).width = m), (y.height = b))
                                : v
                                ? ((d = c.getPages()[p - 1]), (y = l(p, d)))
                                : ((d = f.getPages()[p - 1]), (y = l(p, d))),
                              this.addPage(y);
                                      ...
                                      return s().wrap(function(t) {
                                        for (;;)
                                          switch ((t.prev = t.next)) {
                                            case 0:
                                              return (
                                                (e = new x.filesToCompare[r].Core.DocumentViewer()).setViewerElement(document.createElement('div')),
