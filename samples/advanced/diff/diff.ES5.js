  ...
  function(t, n) {
    ...
    !(function(t) {
            ...
            return regeneratorRuntime.wrap(function(t) {
              for (;;)
                switch ((t.prev = t.next)) {
                  case 0:
                    return (t.next = 2), g(n).loadDocument(r);
                  case 2:
                  case 'end':
                    return t.stop();
                }
      ...
      function E(t, n, r, e, o, i) {
        y(v).updatePageWithAlignment(r, e, t, n, i, o);
      }
      function O(e) {
        return new Promise(function(o) {
          var u = document.getElementById(e.panel);
          WebViewer(
            {
              path: '../../../lib',
              css: './nudge-tool.css',
              workerTransportPromise: S(e.pdf),
            ...
            var a = c.UI,
              ...
              m = a.LayoutMode,
              b = a.FitMode;
            a.disableFeatures([h.Annotations]),
              a.setToolMode('AnnotationEdit'),
              f.addEventListener('documentLoaded', function() {
                a.setLayoutMode(m.Single),
                  a.setFitMode(b.FitWidth),
                  e.panel !== v &&
                    f.getDocument().addEventListener('layersUpdated', function() {
                      var t = g(v);
                      y(v) && (t.refreshAll(), t.updateView());
                    });
                var n = u.querySelector('iframe').contentDocument.querySelector('.DocumentContainer');
                (n.onscroll = function() {
                  var e, o;
                  ...
                  f.addEventListener('zoomUpdated', function(e) {
                    s ||
                      ((s = n),
                      clearTimeout(r),
                      (r = setTimeout(function() {
                  ...
                  f.addEventListener('pageNumberUpdated', function(n) {
                    t.DiffAlignmentTool.isInAlignmentMode()
                      ? e.panel !== d &&
                        l.forEach(function(t) {
                          g(t.panel).getCurrentPage() !== n && t.panel !== d && g(t.panel).setCurrentPage(n);
                        })
                      : _(n);
                  }),
                  (p[e.panel].documentContainer = n);
              }),
              l.push(e),
              (p[e.panel] = { instance: c }),
              o();
          });
        });
      }
            ...
            return regeneratorRuntime.wrap(function(n) {
              for (;;)
                switch ((n.prev = n.next)) {
                  case 0:
                    return (i = !0), (n.next = 3), Promise.all([x(h, r), x(d, e)]);
                  case 3:
                    return (
                      t.DiffAlignmentTool.initializeDiffAlignmentToolHandlers(
                        ...
                        function() {},
                        function() {
                          _(g(v).getCurrentPage());
                        }
                      ),
                      (o = p[h].instance.Core.documentViewer.getDocument()),
                      (u = p[d].instance.Core.documentViewer.getDocument()),
                      (c = [
                        { document: o, Core: p[h].instance.Core },
                        { document: u, Core: p[d].instance.Core },
                      ]),
                      (n.next = 9),
                      t.CompareDocumentManager.initialize(p[v].instance.Core, c, {
      ...
      (a = [{ panel: h }, { panel: v }, { panel: d }]),
                ...
                switch ((n.prev = n.next)) {
                  ...
                  case 2:
                    t.NudgeTool.initializeNudgeTool(function(t) {
                      ...
                      (document.getElementById('enable-snap-mode').disabled = !p[h].instance.Core.isFullPDFEnabled() && !p[d].instance.Core.isFullPDFEnabled());
                  case 4:
                  case 'end':
                    return n.stop();
                }
        ...
        Promise.all(a.map(O)).then(function() {
          return p[v].instance.UI.disableElements(['leftPanelButton', 'searchButton', 'searchPanel', 'searchOverlay']), f();
        }),
        ...
        document.getElementById('enable-opacity-slider').addEventListener('change', function() {
          ...
          t.DiffOverlaySlider.setValue(+r / 100), m();
        }),
        document.getElementById('opacity-slider').addEventListener('change', function() {
          ...
          t.DiffOverlaySlider.setValue(+n / 100), m();
        });
    })(window);
  },
]);
