!(function(t) {
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n, r, v, y, d, g) {
      ...
      if (
        ...
        if (((m = { values: _ ? A : w('values'), keys: d ? A : w('keys'), entries: T }), g)) for (b in m) b in O || i(O, b, m[b]);
  ...
  function(t, n) {
    function r() {
      ...
      return (
        (y.prototype = d),
        o(x, 'constructor', { value: d, configurable: !0 }),
    ...
    !(function(t) {
      ...
      function O(t, n, r, e, o, i) {
        g(y).updatePageWithAlignment(r, e, t, n, i, o);
      }
      function P(r) {
                ...
                (n.onscroll = function() {
                  ...
                  f.addEventListener('pageNumberUpdated', function(n) {
                    t.DiffAlignmentTool.isInAlignmentMode()
                      ? r.panel !== d &&
                        h.forEach(function(t) {
                          m(t.panel).getCurrentPage() !== n && t.panel !== d && m(t.panel).setCurrentPage(n);
                        })
                      : E(n);
                  }),
            ...
            return r().wrap(function(n) {
              for (;;)
                switch ((n.prev = n.next)) {
                  case 0:
                    return (u = !0), (n.next = 3), Promise.all([S(v, e), S(d, o)]);
                  case 3:
                    return (
                      ...
                      (c = p[d].instance.Core.documentViewer.getDocument()),
                      (a = [
                        { document: i, Core: p[v].instance.Core },
                        { document: c, Core: p[d].instance.Core },
                      ]),
                      (n.next = 9),
                      t.CompareDocumentManager.initialize(p[y].instance.Core, a, {
      ...
      (f = [{ panel: v }, { panel: y }, { panel: d }]),
                ...
                switch ((n.prev = n.next)) {
                  ...
                  case 2:
                    t.NudgeTool.initializeNudgeTool(function(t) {
                      ...
                      (document.getElementById('enable-snap-mode').disabled = !p[v].instance.Core.isFullPDFEnabled() && !p[d].instance.Core.isFullPDFEnabled());
                  case 4:
                  case 'end':
                    return n.stop();
                }
        ...
        Promise.all(f.map(P)).then(function() {
          return p[y].instance.UI.disableElements(['leftPanelButton', 'searchButton', 'searchPanel', 'searchOverlay']), s();
        }),
