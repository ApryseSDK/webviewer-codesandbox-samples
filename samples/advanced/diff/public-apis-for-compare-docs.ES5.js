!(function(t) {
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n) {
      ...
      return function(n, c, v) {
        for (var y, g, d = i(n), m = o(d), b = e(c, v, 3), S = u(m.length), x = 0, w = r ? p(n, S) : a ? p(n, 0) : void 0; S > x; x++)
        ...
        Lt = {
          ...
          subarray: function(t, n) {
            var r = Ot(this),
              e = r.length,
              o = m(t, e);
            return new (j(r, r[mt]))(r.buffer, r.byteOffset + o * r.BYTES_PER_ELEMENT, g((void 0 === n ? e : m(n, e)) - o));
          },
        },
        kt = function(t, n) {
      ...
      if (
        ...
        F ||
          (((b = n(function(n, r) {
            f(n, b, t);
            var e = v(new m(), n, b);
            return null != r && a(r, g, e[S], e), e;
          })).prototype = x),
          (x.constructor = b)),
          (O || T) && (_('delete'), _('has'), g && _('get')),
          (T || E) && _(S),
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n, r, v, y, g, d) {
      ...
      if (
        ...
        if (((m = { values: _ ? F : x('values'), keys: g ? F : x('keys'), entries: T }), d)) for (b in m) b in E || i(E, b, m[b]);
        ...
        [
          ...
          function(t, n) {
            ...
            for (var S = 0, x = 0, w = []; x < h.length; ) {
              ...
              var _,
                P = a(m, v ? h : h.slice(x));
              if (null === P || (_ = l(c(m.lastIndex + (v ? 0 : x)), h.length)) === S) x = u(h, x, g);
              else {
  ...
  function(t, n, r) {
    for (
      ...
      var g,
        ...
        b = u[d],
        S = b && b.prototype;
      if (S && (S[s] || c(S, s, h), S[l] || c(S, l, d), (a[d] = h), m)) for (g in e) S[g] || i(S, g, e[g], !0);
    }
  },
  function(t, n, r) {
    (function(t) {
  ...
  function(t, n) {
    ...
    !(function(t) {
      var n,
        r = (e((n = {}), 'right', 1), e(n, 'left', 2), e(n, 'down', 3), e(n, 'up', 4), n),
        o = {
          updatePageWithAlignment: function(n, r, e, o, i, u) {
            if (
              ...
              this.shouldResetInitialPageRotations() &&
                ...
                (y = t.normalizePointToZeroRotationSpace(o, t.Util.convertToWebViewerRotationEnum(s.rotation), s.width, s.height)));
              var g,
                d,
                m,
                b,
                ...
                w =
                  ...
                  (m = v),
                  (b = y),
                  (S = t.Alignment.createMatrixForLineAlignment(g, d, m, b)),
          ...
          translate: function(t, n, e) {
            if (r[t]) {
              var o = this.nudgePageStates.getTransformationStateForPageNumber(e);
              switch (t) {
                case 'up':
              ...
              this.nudgePageStates.setTransformationStateForPageNumber(e, o);
              var i = this.getSourcePageNumberForAlignedPage(e);
              this.updatePageSizeFromTransformationState(i, e, this.shouldResetInitialPageRotations() ? 0 : this.getPage(e).rotation);
            } else console.error('Please pass in a valid direction: '.concat(Object.keys(r).join(',')));
          },
          scale: function(t, n) {
