      ...
      function i(t, o, i, u, c) {
        e
          ? ((e = !1),
            ...
            o.Core.documentViewer.getAnnotationManager().deleteAnnotations(o.Core.documentViewer.getAnnotationManager().getAnnotationsList(), { imported: !0, force: !0 }),
            (n = void 0),
            (r = void 0),
            c && c())
          : ((e = !0), (i.textContent = 'Leave Alignment Mode'), t.UI.setToolMode('AnnotationCreateArrow'), o.UI.setToolMode('AnnotationCreateArrow'), u && u());
      }
      t.DiffAlignmentTool = {
        initializeDiffAlignmentToolHandlers: function(t, u, c, f, a) {
          (n = void 0), (r = void 0);
          var s = document.getElementById('toggle-alignment-mode');
          e && i(t, u, s, f, a),
            t.Core.documentViewer.getTool('AnnotationCreateArrow').addEventListener('annotationAdded', function(r) {
              n && t.Core.documentViewer.getAnnotationManager().deleteAnnotation(n, { imported: !1, force: !0 }), (r.ReadOnly = !0), (n = r), o(c);
            }),
            u.Core.documentViewer.getTool('AnnotationCreateArrow').addEventListener('annotationAdded', function(t) {
              r && u.Core.documentViewer.getAnnotationManager().deleteAnnotation(r, { imported: !1, force: !0 }), (t.ReadOnly = !0), (r = t), o(c);
            }),
            (s.onclick = function() {
              i(t, u, s, f, a);
            }),
            (document.getElementById('enable-snap-mode').onchange = function(n) {
              ...
              t.Core.documentViewer.getTool('AnnotationCreateArrow').setSnapMode(r ? t.Core.documentViewer.SnapMode.DEFAULT : null),
                u.Core.documentViewer.getTool('AnnotationCreateArrow').setSnapMode(r ? u.Core.documentViewer.SnapMode.DEFAULT : null);
            });
        },
