  ...
  function(t, n) {
    ...
    !(function(t) {
      ...
      var o,
        ...
        u = {
          initialize:
            ((o = regeneratorRuntime.mark(function r(e, o, i) {
                ...
                function(r) {
                  for (;;)
                    switch ((r.prev = r.next)) {
                      case 0:
                        return (
                          (this.documentViewer = e.documentViewer),
                          (n.prototype = Object.create(e.BaseDocument.prototype)),
                          Object.assign(n.prototype, t.FunctionsToOverride),
                          Object.assign(n.prototype, t.PublicAPIsForCompareDocs),
                          e.Document.registerDocumentType('compare-docs', n, Object.keys(t.PublicAPIsForCompareDocs)),
                          (r.next = 7),
                          u.loadDocumentsToCompare(o, i)
                        );
                      case 7:
                      case 'end':
                        return r.stop();
          ...
          loadDocumentsToCompare: function() {
            ...
            if (n && n.diffAnnotations) {
              if (e()) throw new Error('diffing annotations is not supported in IE11');
              if (
                t.some(function(t) {
                  return !t.Core;
                })
