          ...
          b
            ? ((v = r(function(t, r, e, o) {
                ...
                var i,
                  ...
                  h = 0;
                if (S(r)) {
                  if (!(r instanceof K || 'ArrayBuffer' == (a = w(r)) || 'SharedArrayBuffer' == a)) return xt in r ? Mt(v, r) : It.call(v, r);
                  (i = r), (h = Ot(e, n));
                  var d = r.byteLength;
                  if (void 0 === o) {
                ...
                switch ((t.prev = t.next)) {
                  case 0:
                    return (
                      ...
                      (c = o.iframeWindow),
                      (a = o.Theme),
                      n.UI.setTheme(a.DARK),
                      (f = i.getAnnotationManager()),
                    ...
                    'https://pdftron.s3.amazonaws.com/downloads/pl/video/video.mp4',
                                      ...
                                      case 0:
                                        return (
                                          ...
                                          (r = i
                                            ...
                                            .getAllAnnotations()),
                                          (t.next = 4),
                                          f.exportAnnotations({ links: !1, widgets: !1, annotList: r })
                                        );
                                      case 4:
                      ...
                      i.addEventListener('pageComplete', function(t, n) {
                        if (!s) {
                          ...
                          var h = l.querySelector('#play'),
                            ...
                            w = function(t) {
                              ...
                              t.forEach(function(t) {
                                if (t.startTime <= a.duration) {
                                  var n = document.createElement('div');
                                  n.className = 'marker';
                                  var r = t.startTime / a.duration;
                                  n.onclick = function() {
                                    j(t.startTime);
                                  };
                          ...
                          f.addEventListener('annotationChanged', function() {
                            w(a.getAllAnnotations());
                          }),
                            w(a.getAllAnnotations()),
                                      ...
                                      switch ((t.prev = t.next)) {
                                        case 0:
                                          o.getVideo().updateAnnotationsToTime(x.currentTime),
                                            ...
                                            (n = a.getFrameFromTime(x.currentTime)),
                          ...
                          var M,
                            j = function(t) {
                              (x.currentTime = t), (y.value = x.currentTime), (m.innerHTML = ''.concat(a.getFormattedCurrentTime()));
                              var n = 100.5 * (a.getFrameFromTime(x.currentTime) - 1) - S.clientWidth / 2 + 46.25;
                          ...
                          y.addEventListener('click', function(t) {
                            ...
                            y.addEventListener('mousemove', function(t) {
                              ...
                              (M = r), b.setAttribute('data-state', 'visible'), (b.style = 'left: '.concat(t.offsetX, 'px;')), (b.innerHTML = ''.concat(a.getFormattedTime(r)));
                            }),
