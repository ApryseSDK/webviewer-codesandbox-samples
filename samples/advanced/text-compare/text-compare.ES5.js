!(function(t) {
  ...
  function(t, n, e) {
    ...
    t.exports = function(t, n) {
      ...
      return function(n, c, v) {
        for (var d, y, g = i(n), m = o(g), b = r(c, v, 3), x = u(m.length), w = 0, S = e ? p(n, x) : a ? p(n, 0) : void 0; x > w; w++)
  ...
  function(t, n, e) {
    ...
    if (e(8)) {
      var o = e(30),
        ...
        Vt = function(t, n) {
          return S(t) && t[xt] && 'symbol' != r(n) && n in t && String(+n) == String(n);
        },
        Dt = function(t, n) {
          return Vt(t, (n = b(n, !0))) ? h(2, t[n]) : U(t, n);
        },
        Wt = function(t, n, e) {
          return !(Vt(t, (n = b(n, !0))) && S(e) && x(e, 'value')) || x(e, 'get') || x(e, 'set') || e.configurable || (x(e, 'writable') && !e.writable) || (x(e, 'enumerable') && !e.enumerable)
            ? q(t, n, e)
            : ((t[n] = e.value), t);
        };
      bt || ((W.f = Dt), (D.f = Wt)),
      ...
      v(qt, Bt),
        p(qt, dt, Bt.values),
        v(qt, { slice: kt, set: Rt, constructor: function() {}, toString: pt, toLocaleString: jt }),
        Ft(qt, 'buffer', 'b'),
        Ft(qt, 'byteOffset', 'o'),
        Ft(qt, 'byteLength', 'l'),
        Ft(qt, 'length', 'e'),
          ...
          b
            ? ((v = e(function(t, e, r, o) {
                ...
                var i,
                  ...
                  h = 0;
                if (S(e)) {
                  if (!(e instanceof $ || 'ArrayBuffer' == (a = w(e)) || 'SharedArrayBuffer' == a)) return xt in e ? Lt(v, e) : Ct.call(v, e);
                  (i = e), (h = Pt(r, n));
                  var d = e.byteLength;
                  if (void 0 === o) {
  ...
  function(t, n, e) {
    ...
    t.exports = function(t, n, e, v, d, y, g) {
      ...
      var m,
        ...
        I = O || w(d),
        M = d ? (E ? w('entries') : I) : void 0,
        L = ('Array' == n && P.entries) || O;
      if (
        (L && (x = s(L.call(new t()))) !== Object.prototype && x.next && (f(x, S, !0), r || 'function' == typeof x[l] || u(x, l, p)),
        E &&
          O &&
          'values' !== O.name &&
          ((_ = !0),
        ...
        if (((m = { values: E ? I : w('values'), keys: y ? I : w('keys'), entries: M }), g)) for (b in m) b in P || i(P, b, m[b]);
  ...
  function(t, n, e) {
    ...
    var r,
      ...
      C = !!(function() {
        try {
          ...
          return (M || 'function' == typeof PromiseRejectionEvent) && t.then(L) instanceof n && 0 !== O.indexOf('6.6') && -1 === w.indexOf('Chrome/66');
        } catch (t) {}
      })(),
      T = function(t) {
        var n;
    ...
    C ||
      ...
      (i = function() {
        var t = new r();
        (this.promise = t), (this.resolve = f(B, t, 1)), (this.reject = f(R, t, 1));
      }),
      (b.f = F = function(t) {
    ...
    var o = e(1),
      ...
      J = function(t, n, e) {
        return (
          ...
          (n = E(n, !0)),
          b(e),
          i(W, n) ? (e.enumerable ? (i(t, R) && t[R][n] && (t[R][n] = !1), (e = P(e, { enumerable: _(0, !1) }))) : (i(t, R) || T(t, R, _(1, {})), (t[R][n] = !0)), Y(t, n, e)) : T(t, n, e)
        );
      },
      X = function(t, n) {
        b(t);
      ...
      Z = function(t) {
        ...
        return !(this === U && i(W, t) && !i(q, t)) && (!(n || !i(this, t) || !i(W, t) || (i(this, R) && this[R][t])) || n);
      },
      Q = function(t, n) {
      ...
      tt = function(t) {
        for (var n, e = A(S(t)), r = [], o = 0; e.length > o; ) i(W, (n = e[o++])) || n == R || n == f || r.push(n);
        return r;
      },
      nt = function(t) {
      ...
      (a(
        (j = function() {
          ...
          var t = p(arguments.length > 0 ? arguments[0] : void 0),
            n = function n(e) {
              this === U && n.call(q, e), i(this, R) && i(this[R], t) && (this[R][t] = !1), Y(this, t, _(1, e));
            };
      ...
      return [
        ...
        function(t, n) {
          ...
          for (var x, w = '', S = 0, E = 0; E < m.length; E++) {
            b = m[E];
            for (var _ = String(b[0]), P = f(s(u(b.index), h.length), 0), O = [], I = 1; I < b.length; I++) O.push(void 0 === (x = b[I]) ? x : String(x));
            var M = b.groups;
            if (p) {
            ...
            P >= S && ((w += h.slice(S, P) + F), (S = P + _.length));
          }
          return w + h.slice(S);
        },
      ];
        ...
        [
          ...
          function(t, n) {
            ...
            for (var x = 0, w = 0, S = []; w < h.length; ) {
              ...
              var E,
                _ = a(m, v ? h : h.slice(w));
              if (null === _ || (E = l(c(m.lastIndex + (v ? 0 : w)), h.length)) === x) w = u(h, w, y);
              else {
  ...
  function(t, n, e) {
    for (
      ...
      var y,
        ...
        b = u[g],
        x = b && b.prototype;
      if (x && (x[s] || c(x, s, h), x[l] || c(x, l, g), (a[g] = h), m)) for (y in r) x[y] || i(x, y, r[y], !0);
    }
  },
  function(t, n, e) {
    (function(t) {
        ...
        return (
          ...
          (O.prototype = {
            ...
            delegateYield: function(t, n, e) {
              return (this.delegate = { iterator: I(t), resultName: n, nextLoc: e }), 'next' === this.method && (this.arg = void 0), h;
            },
          }),
          t
        );
    ...
    function r() {
      ...
      function l(t, n, e, r) {
        var o = n && n.prototype instanceof v ? n : v,
          ...
          c = new I(r || []);
        return i(u, '_invoke', { value: E(t, e, c) }), u;
      }
      function h(t, n, e) {
        try {
          return { type: 'normal', arg: t.call(n, e) };
      ...
      return (
        ...
        (I.prototype = {
          ...
          delegateYield: function(t, n, e) {
            return (this.delegate = { iterator: M(t), resultName: n, nextLoc: e }), 'next' === this.method && (this.arg = void 0), p;
          },
        }),
        t
      );
                ...
                switch ((t.prev = t.next)) {
                  ...
                  case 5:
                    (o = t.sent),
                      ...
                      (s = r().mark(function t(n) {
                        var e, o, s, l, p, v, d, y, g, m, b, x, w, S, E, _, P;
                        return r().wrap(function(t) {
                          for (;;)
                            switch ((t.prev = t.next)) {
                              case 0:
                                (e = f[n]),
                                  ...
                                  e.removed || e.added
                                    ? ((g = ''),
                                      n + 1 < f.length &&
                                        (f[n + 1].removed || f[n + 1].added) &&
                                        ((g = f[n + 1].value),
                                        o.setAttribute('section', c),
                                        s.setAttribute('section', c),
                                        a[0].pageTextSections.push(f[n].value),
                                        a[1].pageTextSections.push(f[n + 1].value),
                                        n++),
                                      (m = Diff.diffChars(e.value, g)),
                                      (b = ''),
                                      (x = ''),
                                      (w = 'background-color: '.concat(a[1].highlightColor, '; color: ').concat(a[1].textColor, ';')),
                                      (S = 'background-color:'.concat(a[0].highlightColor, '; color: ').concat(a[0].textColor, ';')),
                                      m.forEach(function(t) {
                                        var n = t.value.replace(/\r?\n/g, '&nbsp;<br />');
                                        t.removed || t.added
                                          ? t.added
                                            ? (x += n.replace(/\s/g, '').length ? '<span style="'.concat(w, '">').concat(n, '</span>') : n)
                                            : t.removed && (b += n.replace(/\s/g, '').length ? '<span style="'.concat(S, '">').concat(n, '</span>') : n)
                                          : ((b += '<span>'.concat(n, '</span>')), (x += '<span>'.concat(n, '</span>')));
                                      }),
                                      (s.style.backgroundColor = a[1].backgroundColor),
                                      (o.style.backgroundColor = a[0].backgroundColor),
                                      ((E = document.createElement('p')).innerHTML = b),
                                      o.appendChild(E),
                                      i.appendChild(o),
                                      ((_ = document.createElement('p')).innerHTML = x),
                                      s.appendChild(_),
                                      u.appendChild(s),
                                      (P = Math.max(s.scrollHeight, o.scrollHeight)),
                                      (s.style.height = ''.concat(P, 'px')),
                                      (o.style.height = ''.concat(P, 'px')))
                                    : (a[0].pageTextSections.push(e.value),
                                      a[1].pageTextSections.push(e.value),
                                      o.setAttribute('section', c),
                                      s.setAttribute('section', c),
                                      (o.className = 'section identical'),
                                      (s.className = 'section identical'),
                                      ...
                                      (v.innerHTML = e.value.replace(/\r?\n/g, '<br />')),
                                      (v.className = 'hidden'),
                                      (d.innerHTML = e.value.replace(/\r?\n/g, '<br />')),
                                      (d.className = 'hidden'),
                                      s.appendChild(v),
                                      o.appendChild(d),
                                      o.appendChild(l),
                                      ...
                                      (y = function() {
                                        if (!window.getSelection().toString()) {
                                          var t = !('hidden' !== d.className);
                                          (d.className = t ? '' : 'hidden'), (v.className = t ? '' : 'hidden'), (p.className = t ? 'hidden' : ''), (l.className = t ? 'hidden' : '');
                                        }
                                      }),
                                      s.addEventListener('mouseup', y),
                                      o.addEventListener('mouseup', y),
                                      i.appendChild(o),
                                      u.appendChild(s)),
                                  c++,
                                  (h = n);
                  ...
                  case 16:
                    ...
                    return t.delegateYield(s(h), 't0', 18);
                  case 18:
                    h++, (t.next = 16);
                    break;
                  case 21:
