!(function(t) {
          ...
          m
            ? ((v = r(function(t, r, e, o) {
                ...
                var i,
                  ...
                  h = 0;
                if (w(r)) {
                  if (!(r instanceof K || 'ArrayBuffer' == (f = x(r)) || 'SharedArrayBuffer' == f)) return St in r ? It(v, r) : At.call(v, r);
                  (i = r), (h = Ot(e, n));
                  var y = r.byteLength;
                  if (void 0 === o) {
  ...
  function(t, n) {
    WebViewer({ path: '../../../lib', initialDoc: 'https://pdftron.s3.amazonaws.com/downloads/pl/demo-annotated.pdf', enableFilePicker: !0 }, document.getElementById('viewer')).then(function(t) {
      samplesSetup(t),
